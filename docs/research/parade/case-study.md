...
- [PARADE 精读笔记与术语表](reading-notes.md)
- [项目检索实验记录](../../experiments/retrieval/results.md)
- [Parent-Child 消融设计](../../archive/retrieval/2026-07-18-parent-child-retrieval-ablation-design.md)
- [H1 Top-2 聚合实验设计](../../archive/retrieval/2026-07-19-parent-child-h1-top2-aggregation-design.md)
