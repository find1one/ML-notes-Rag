...
> 状态说明（2026-07-19）：本文是展示页的信息架构设计，文中的 35-case 指标是设计时快照。当前 120-case 指标和 Parent–Child 消融结果以 `README.md` 与 `docs/experiments/retrieval/results.md` 为准。
...
4. 锚点跳转后仍可继续上下滚动；
5. Offline Plane、Verified Index Contract 和 Online Plane 的文案与 `docs/architecture/system-overview.md`、`AGENTS.md` 一致；
